...
const notificationsSeed = [
  {
    ...
    body: "Copperfield Bank · Rs 108,500",
    time: "8m ago",
    read: false,
    kind: "deal",
  },
  {
    id: 2,
    title: "New comment on Quartz Health Group",
    body: "Elena Cho left a note",
    time: "41m ago",
    read: false,
    kind: "comment",
  },
  {
    ...
    body: "Follow up call with Ridgeline Freight",
    time: "2h ago",
    read: false,
    kind: "task",
  },
  {
    id: 4,
    title: "Deal won ",
    body: "Tidewater Media · Rs 62,100",
    time: "1d ago",
    read: true,
    kind: "deal",
  },
  {
    ...
    body: "Pipeline summary for Jun 24–30",
    time: "2d ago",
    read: true,
    kind: "report",
  },
...
const currency = (n) =>
  "Rs " + n.toLocaleString("en-US", { maximumFractionDigits: 0 });
...
function LoginScreen({ onLogin, c }) {
  ...
  const [email, setEmail] = useState("irajmukhtar@email");
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-[920px] grid md:grid-cols-2 rounded-2xl overflow-hidden shadow-xl"
      ...
      >
        ...
        >
          <div>
            ...
            >
              Every account, every deal, every quarter — one pipeline that never
              loses the thread.
            </p>
          </div>
          <div className="space-y-4">
            {[
              ["Rs 1.4M", "pipeline tracked this quarter"],
        ...
        <div className="p-8 md:p-10" style={{ background: c.surface }}>
          ...
          <p className="text-sm mt-1" style={{ color: c.textSub }}>
            Welcome back. Pick a role to preview the workspace.
          </p>
...
function KpiCard({ label, value, delta, positive, icon: Icon, c }) {
  return (
    <div
      className="rounded-xl p-4 flex-1 min-w-[180px]"
    ...
    >
      ...
      >
        ...
        <span style={{ color: c.textFaint, fontFamily: "Inter, sans-serif" }}>
          vs last month
        </span>
      </div>
    </div>
...
function Sidebar({
  ...
  return (
    <>
      ...
      >
        <div
          className="flex items-center gap-2 px-5 h-16 shrink-0"
        ...
        <div className="p-3" style={{ borderTop: `1px solid ${c.border}` }}>
          ...
          >
            ...
            <div className="font-medium mt-0.5" style={{ color: c.text }}>
...
function NotificationsPanel({ c, notifications, setNotifications, onClose }) {
  return (
    <div
      className="absolute right-0 top-12 w-80 rounded-xl shadow-lg overflow-hidden z-50"
      style={{ background: c.surface, border: `1px solid ${c.border}` }}
    >
      <div
        ...
        {notifications.map((n) => (
          <div
            ...
            style={{
              ...
              background: n.read ? "transparent" : c.brandSoft,
            }}
            onClick={() =>
          ...
          >
            <div
              ...
              style={{ background: n.read ? "transparent" : c.accent }}
            />
            <div>
...
function Topbar({
  ...
  return (
    <header
      className="sticky top-0 z-20 h-16 flex items-center gap-3 px-4 md:px-6"
    ...
    >
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        >
          {theme === "light" ? (
            <Moon size={16} color={c.textSub} />
          ) : (
            <Sun size={16} color={c.textSub} />
          )}
        </button>
        ...
        <div className="relative">
          ...
          >
            ...
            {unread > 0 && (
              <span
                className="absolute -top-1 -right-1 min-w-[16px] h-4 px-1 rounded-full text-[10px] flex items-center justify-center font-semibold"
                style={{
                  background: c.danger,
                  color: "#fff",
                  fontFamily: "JetBrains Mono, monospace",
        ...
        <div className="relative">
          ...
          {profileOpen && (
            <div
              className="absolute right-0 top-12 w-56 rounded-xl shadow-lg overflow-hidden z-50"
              style={{ background: c.surface, border: `1px solid ${c.border}` }}
            >
              <div
                className="px-4 py-3"
  ...
  return (
    <ResponsiveContainer width="100%" height={220}>
      <AreaChart data={revenueTrend} margin={{ left: -20, right: 10 }}>
        ...
        <XAxis
          dataKey="m"
          tick={{ fontSize: 11, fill: c.textSub, fontFamily: "Inter" }}
  ...
  return (
    <ResponsiveContainer width="100%" height={220}>
      <BarChart data={stageCounts} margin={{ left: -20, right: 10 }}>
        ...
        <XAxis
          dataKey="stage"
          tick={{ fontSize: 10, fill: c.textSub, fontFamily: "Inter" }}
          axisLine={{ stroke: c.border }}
          tickLine={false}
          interval={0}
          angle={-15}
...
function DealsTable({ c, rows, ownersById }) {
  ...
  const SortIcon = ({ col }) => {
    if (sortKey !== col)
      return <ChevronsUpDown size={12} color={c.textFaint} />;
    return sortDir === "asc" ? (
  ...
  return (
    ...
    >
      <div
        ...
        style={{ borderBottom: `1px solid ${c.border}` }}
      >
        <p className="text-sm font-semibold mr-auto" style={{ color: c.text }}>
          ...
          <tbody>
            {pageRows.map((d) => (
              <tr key={d.id} style={{ borderTop: `1px solid ${c.border}` }}>
                ...
                <td className="px-4 py-3" style={{ color: c.textSub }}>
                  {ownersById[d.ownerId]?.name}
                </td>
                <td className="px-4 py-3">
                  <Badge tone={stageStyle[d.stage]} c={c}>
                    {d.stage}
                  </Badge>
                </td>
                <td
...
function OverviewPage({ c, role, user, visibleDeals, ownersById }) {
  ...
  const openCount = visibleDeals.filter(
  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm mt-1" style={{ color: c.textSub }}>
          Here's what's moving across your accounts this week.
        </p>
      </div>
            ...
            {sourceSplit.map((s, i) => (
              ...
              >
                <span
                  ...
                  style={{ background: c[SOURCE_COLORS[i]] }}
                />
                {s.name}
              </div>
            ))}
...
function CustomersPage({ c, rows, ownersById, search }) {
  const customers = useMemo(() => {
    ...
    return Object.values(map).filter((c2) =>
      c2.name.toLowerCase().includes(search.toLowerCase()),
    );
  }, [rows, search]);
  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm mt-1" style={{ color: c.textSub }}>
          {customers.length} accounts in view
        </p>
      </div>
        ...
        {customers.map((cu) => (
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <Badge tone={stageStyle[cu.stage]} c={c}>
                {cu.stage}
              </Badge>
            </div>
            ...
            <p className="text-xs mt-0.5" style={{ color: c.textSub }}>
              Owner: {ownersById[cu.owner]?.name}
            </p>
            <div
...
export default function CRMDashboard() {
  ...
  const visibleDeals = useMemo(() => {
    let base = deals;
    if (role === "rep" && user)
      base = base.filter((d) => ownersById[d.ownerId]?.name === user.name);
    if (search)
      base = base.filter((d) =>
  ...
  if (active === "overview")
    ...
    page = (
      <SimpleTablePage
        c={c}
        title="Pipeline"
        subtitle="Every open and closed deal."
        rows={visibleDeals}
        ownersById={ownersById}
      />
    );
  else if (active === "mydeals")
    page = (
      <SimpleTablePage
        c={c}
        title="My Deals"
        subtitle="Deals assigned to you."
        rows={visibleDeals}
        ownersById={ownersById}
      />
    );
    ...
    page = <SettingsPage c={c} theme={theme} setTheme={setTheme} />;
